...
import { useDynamicMailTemplateSearch } from "@/hooks/queries/use-dynamic-mail-template"
...
interface DynamicTemplateComboboxProps {
...
export function DynamicTemplateCombobox({
  value,
  onChange,
  onBlur,
  error,
  departmentId,
}: DynamicTemplateComboboxProps) {
